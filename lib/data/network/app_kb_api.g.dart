...
class _AppKbServiceClient implements AppKbServiceClient {
  ...
  Future<GetKnowledgeRelationResponse> getKnowledgeRelation(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetKnowledgeRelationResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          '/kb-core/v1/knowledge/assistant-relationship/${assistantId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetKnowledgeRelationResponse _value;
    try {
      _value = GetKnowledgeRelationResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
